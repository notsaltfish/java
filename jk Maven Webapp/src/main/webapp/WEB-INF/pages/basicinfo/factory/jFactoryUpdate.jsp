		...
		<table class="commonTable" cellspacing="1">
	        <tr>
	          ...
	          <td class="tableContent">
	         		 <input type="text" name="fullName" value="${obj.fullName }"/>
	          </td>   
	            <td class="columnTitle_mustbe">简称：</td>
	            <td class="tableContent">
	            <input type="text" name="factoryName" value="${obj.factoryName }"/></td>
	        </tr>
	         <tr>
	            <td class="columnTitle_mustbe">联系人：</td>
	          <td class="tableContent">
	         		 <input type="text" name="contacts" value="${obj.contacts }"/>
	          </td>   
	            <td class="columnTitle_mustbe">电话号码：</td>
	            <td class="tableContent"><input type="text" name="phone" value="${obj.phone }" /></td>
	        </tr>
	         <tr>
	            <td class="columnTitle_mustbe">手机号码：</td>
	          <td class="tableContent">
	         		 <input type="text" name="mobile"  value="${obj.mobile }"/>
	          </td>   
	        ...
	        <tr>
	          ...
	          <td class="tableContent">
	            ...
	            <td class="columnTitle_mustbe">检查员：</td>
	            <td class="tableContent"><input type="text" name="inspector" value="${obj.inspector }" /></td>
	        </tr>
	        <tr>
	             <td class="columnTitle_mustbe">备注：</td>
	          <td class="tableContent">
	         		 <textarea name="note" style="height:120px;">${obj.note }</textarea>
	          </td>  
	        </tr>
