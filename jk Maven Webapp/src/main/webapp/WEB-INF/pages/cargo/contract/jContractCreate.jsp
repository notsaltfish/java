		...
		<table class="commonTable" cellspacing="1">
	        <tr>
	          ...
	          <td class="tableContent">
	            ...
	            <td class="tableContent"><input type="text" name="offeror" value="杰信商务有限公司"/></td>
	        </tr>
	         <tr>
	          ...
	          <td class="tableContent">
	            ...
	            <input type="radio"  class="input" name="printStyle" checked value="1"/>一款
	            <input type="radio" class="input" name="printStyle" value="2" />二款
	            </td>
	        </tr>
	         <tr>
	          ...
	          <td class="tableContent">
	            ...
	            <td class="tableContentAuto"><input type="radio" name="importNum" value="3" class="input" checked>★★★
	        ...
	        <tr>
	          ...
	          <td class="tableContent">
	         		 <textarea name="crequest" style="height:120px;"></textarea>
