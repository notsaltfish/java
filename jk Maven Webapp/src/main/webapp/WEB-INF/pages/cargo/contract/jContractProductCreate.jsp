    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	         ...
	         <tr>
	          ...
	          <td class="tableContent">
	            ...
	            <td class="tableContentAuto">
	            <input type="text" name="outNumber"/>
	            	</td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">装率：</td>
	          <td class="tableContent">
	         		 <input type="text" name="loadingRate"  />
	          </td>  
	        ...
	        <tr>
	          ...
	          <td class="tableContent">
	         		 <textarea name="exts" style="height:120px;"></textarea>
	             <td class="columnTitle_mustbe">排序号：</td>
	          <td class="tableContent">
	         		 <textarea name="orderNo" style="height:120px;"></textarea>
	          </td>  
	        </tr>
		</table>
	</div>
