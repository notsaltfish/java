...
<div>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            <td class="columnTitle_mustbe">合同及确认编号：</td>
	          <td class="tableContent">
	         		 <input type="text" name="customerContract"  value="${obj. customerContract}" />
	          </td>   
	         ...
	         <tr>
	          ...
	          <td class="tableContent">
	         		 <input type="text" name="consignee" value="${obj.consignee}"  />
	          </td>   
	            <td class="columnTitle_mustbe">运输方式：</td>
	            <td class="tableContentAuto">
	            
	            <input type="radio"  class="input" name="transportMode"  value="AIR" <c:if test="${obj.transportMode=='AIR'}">checked</c:if> value="1"/>AIR
	            <input type="radio" class="input" name="transportMode"  value=" SEA" <c:if test="${obj.transportMode=='SEA'}">checked</c:if> value="2" />SEA
	            </td>
	        </tr>
	         <tr>
	          ...
	          <td class="tableContent">
	         		 <input type="text" name="inputDate"
	         		  value="<fmt:formatDate value='${obj.inputDate}' pattern='yyyy-MM-dd'/>"  onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});" />
	          </td>   
	            <td class="columnTitle_mustbe">价格条件：</td>
	            <td class="tableContentAuto"><input type="radio" name="priceCondition"  value="FOB" class="input" <c:if test="${obj.priceCondition=='FOB'}">checked</c:if>>FOB
	        ...
	        <tr>
	          ...
	          <td class="tableContent">
	         		 <input type="text" name="shipmentPort"  
	         		value="${obj.shipmentPort }"/>
	          </td>  
	          ...
	          <td class="tableContent">
	         		 <textarea name="marks" style="height:120px;">${obj. marks} </textarea>
	          </td>  
	        </tr>
